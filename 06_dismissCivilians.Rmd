# V20_6: Dismiss Civilians

There are 1611 Non-NA responses to the Dismiss Civilians question (V20_6). 
...
data %>% 
  ...
  drop_na(dismiss_civilians) %>% 
  summarize(avg = mean(dismiss_civilians), se = sd(dismiss_civilians)/sqrt(length(dismiss_civilians))) %>%
  ...
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Islamist? V19") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Islamist? V25") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Islamist? V27") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Islamist? V15") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Democrat? V24") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Civilians (0-1)", color = "Anti-American? V26") +
  ylim(c(0, 1)) +
  scale_color_manual(
