# V20_2: Journalist Imprisonment

There are 1605 Non-NA responses to the Journalist Imprisonment question (V20_2). 
...
data %>% 
  ...
  drop_na(imprison_journalists) %>% 
  summarize(avg = mean(imprison_journalists), se = sd(imprison_journalists)/sqrt(length(imprison_journalists))) %>%
  ...
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Islamist? V19") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Islamist? V25") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Islamist? V27") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Islamist? V15") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Democrat? V24") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Journalist Imprisonment (0-1)", color = "Anti-American? V26") +
  ylim(c(0, 1)) +
  scale_color_manual(
