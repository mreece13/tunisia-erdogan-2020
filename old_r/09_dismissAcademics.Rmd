# V20_9: Dismiss Academics

There are 1451 Non-NA responses to the Dismiss Academics question (V20_9). 
...
data %>% 
  ...
  drop_na(dismiss_academics) %>% 
  summarize(avg = mean(dismiss_academics), se = sd(dismiss_academics)/sqrt(length(dismiss_academics))) %>%
  ...
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Islamist? V19") +
  scale_color_manual(
...
data %>% 
  ...
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Islamist? V25") +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
  theme(text = element_text(size=15, family = "Lato", color = "black"), 
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Islamist? V27") +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
  theme(text = element_text(size=15, family = "Lato", color = "black"), 
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Islamist? V15") +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
  theme(text = element_text(size=15, family = "Lato", color = "black"), 
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Democrat? V24") +
  scale_color_manual(
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Academics (0-1)", color = "Anti-American? V26") +
  scale_color_manual(
