# V20_7: Dismiss Generals

There are 1557 Non-NA responses to the Dismiss Generals question (V20_7). 
...
data %>% 
  ...
  drop_na(dismiss_generals) %>% 
  summarize(avg = mean(dismiss_generals), se = sd(dismiss_generals)/sqrt(length(dismiss_generals))) %>%
  ...
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Islamist? V19") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Islamist? V25") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Islamist? V27") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Islamist? V15") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Democrat? V24") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Dismiss Generals (0-1)", color = "Anti-American? V26") +
  ylim(c(0, 1)) +
  scale_color_manual(
