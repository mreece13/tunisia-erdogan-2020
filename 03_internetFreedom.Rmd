# V20_3: Internet Freedom

There are 1608 Non-NA responses to the Internet Freedom question (V20_3). 
...
data %>% 
  ...
  drop_na(internet_freedom) %>% 
  summarize(avg = mean(internet_freedom), se = sd(internet_freedom)/sqrt(length(internet_freedom))) %>%
  ...
  labs(x = "", y = "Internet Freedom (0-1)", color = "Islamist? V19") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  labs(x = "", y = "Internet Freedom (0-1)", color = "Islamist? V25") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Internet Freedom (0-1)", color = "Islamist? V27") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Internet Freedom (0-1)", color = "Islamist? V15") +
  ylim(c(0, 1)) +
  scale_color_manual(
    labels = c("0" = "Non-Islamist", "1" = "Islamist"), 
    values = c("#008FB3", "#F36E21")) +
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Internet Freedom (0-1)", color = "Democrat? V24") +
  ylim(c(0, 1)) +
  scale_color_manual(
...
data %>% 
  ...
  geom_errorbar(position = position_dodge(width = 0.4), size=1) +
  labs(x = "", y = "Internet Freedom (0-1)", color = "Anti-American? V26") +
  ylim(c(0, 1)) +
  scale_color_manual(
